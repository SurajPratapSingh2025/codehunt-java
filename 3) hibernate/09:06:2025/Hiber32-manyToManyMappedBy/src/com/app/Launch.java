...
//		delete(session);
	...
	private static void readFromAccount(Session session) {
		System.out.println("..........READ FROM ACCOUNT.........");
		...
		*/
		...
		List<Employee> employee=account.getEmployee();
	...
	private static void readFromEmployee(Session session) {
		System.out.println("..........READ FROM EMPLOYEE.........");
		Employee employee = session.get(Employee.class, "e28");
	...
	private static void insert(Session session) {
		...
		Employee employee1=new Employee("e28","raju",account);
		Employee employee2=new Employee("e29","kaju",account);
		
		List<Employee> emList=Arrays.asList(employee1,employee2);
		
		account1.setEmployee(emList);
		account2.setEmployee(emList);
		account3.setEmployee(emList);
