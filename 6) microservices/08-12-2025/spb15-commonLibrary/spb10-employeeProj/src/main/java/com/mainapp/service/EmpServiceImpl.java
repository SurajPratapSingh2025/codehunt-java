...
import com.mainapp.exception.ResourceNotFoundExcep;
...
public class EmpServiceImpl implements EmpService{
	...
	public ApiResponse<EmpEntity> getSingleEmp(String id) {
		Supplier<ResourceNotFoundExcep> supplier = new Supplier<ResourceNotFoundExcep>() {
			@Override
			public ResourceNotFoundExcep get() {
				return new ResourceNotFoundExcep("Resource Not Found with id: "+id);
			}
		};
